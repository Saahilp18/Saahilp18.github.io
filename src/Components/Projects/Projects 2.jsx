...
export default function Projects(){
    ...
    return (
        <div className="projects" id = "project">
            ...
            <h2 className='desc'>Created a project that would allow students to submit lengthy YouTube videos or articles and receive a short summary based on a set of key words
