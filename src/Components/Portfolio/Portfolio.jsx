    ...
    return (
        <div className="portfolio" id = "portfolio">
            ...
            <h2 className='companyInfo'>
                ...
                service involves helping select the cheapest and most efficient shipping option to get a shipment to the customer on or 
                before the promised delivery date. My task was to reduce internal team expenditure on expensive API calls to store eligible 
                routes for a shipment. By intelligently refactoring the method of storing routes, I saved a projected $1,833,000 annually for 
                the team. I was also able to assist in removing redundant capacity caps, causing the under-utilization of Amazon-owned trucks 
                and planes when determining viable ship options during Prime Day events. This enabled Amazon's first-party resources to be able 
                to receive a higher volume of shipments while staying under the max capacity. In addition, I was also able to document a critical 
                code deployment process with steps and explanations of tooling, such as creating a custom dependency graph, building code changes, 
                and deploying code in a production-simulated environment.
            </h2>
            <br></br>
            <br></br>
            ...
            <h2 className='companyInfo'>
                As an LA, I have led several classes of students learning computer science in topics regarding
                data structures, object oriented programming, graph theory, trees, and searching/sorting methods.
            </h2>
        </div>
    )
}
